...
public class Room extends BaseActor {
    ...
    //Class contains some of the methods required to procedurally generate the maze
    ...
    private final Wall[] wallArray;
    private final Room[] neighborArray; // some may be null

    private boolean connected;  // used in maze generation

    private boolean visited;    // used in path-finding
    private Room previousRoom;  // used in path-finding
